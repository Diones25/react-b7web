...
const StudentTable = ({ students }:Props) => {
  return (
    <table className="w-full border border-gray-600 rounded-md overflow-hidden text-white">
      <thead>
      ...
      <tbody>
        {students.map(item => (
          <tr key={item.id} className="bg-gray-600 border border-gray-500 text-gray-300">
